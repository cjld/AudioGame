...
//			buffer.append("茫鈧拷猫炉鈥犆ニ喡烩�溍ε九撁ｂ偓鈥�" + raw.getFirstChild().getNodeValue());
//			buffer.append("\n");
			
			Element e = (Element)root.getElementsByTagName("result").item(0);
			
			Element focus = (Element)e.getElementsByTagName("focus").item(0);
			buffer.append("茫鈧拷FOCUS茫鈧��" + focus.getFirstChild().getNodeValue());
			buffer.append("\n");
			...
			buffer.append("茫鈧拷ACTION茫鈧��" + operation.getFirstChild().getNodeValue());
			buffer.append("\n");
